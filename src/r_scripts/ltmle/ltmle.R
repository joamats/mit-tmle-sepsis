...
get_lnodes <- function(treatment) {
    ...
    if (treatment == "ventilation_bin") {
        ...
        l1 <- c("hospitalid1","gender1", "anchor_age1", "charlson_comorbidity_index1", "SOFA1", "pressor1", "rrt1", "anchor_year_group1")
        l2 <- c("hospitalid2","gender2", "anchor_age2", "charlson_comorbidity_index2", "SOFA2", "pressor2", "rrt2", "anchor_year_group2")

    } else if (treatment == "rrt") {

        l1 <- c("hospitalid1","gender1", "anchor_age1", "charlson_comorbidity_index1", "SOFA1", "pressor1", "ventilation_bin1", "anchor_year_group1")
        l2 <- c("hospitalid2","gender2", "anchor_age2", "charlson_comorbidity_index2", "SOFA2", "pressor2", "ventilation_bin2", "anchor_year_group2")

    } else if (treatment == "pressor") {
        l1 <- c("hospitalid1","gender1", "anchor_age1", "charlson_comorbidity_index1", "SOFA1", "rrt1", "ventilation_bin1", "anchor_year_group1")
        l2 <- c("hospitalid2","gender2", "anchor_age2", "charlson_comorbidity_index2", "SOFA2", "rrt2", "ventilation_bin2", "anchor_year_group2")
    }
